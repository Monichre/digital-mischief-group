...
const STEPS: StepConfig[] = [
  ...
  },
  {
    ...
    type: 'textarea',
    placeholder:
      'Describe your current pain points with AI, automation, or data...',
                ...
                {isComplete ? (
                  ...
                  >
                    ...
                    <p className='text-zinc-400 max-w-md mb-8'>
                      ...
                      Book a slot to discuss your architecture map and friction
                      report.
                    </p>
                    <div className='flex flex-col sm:flex-row gap-3'>
                      <a
                        ...
                        className='px-6 py-3 bg-orange-500 text-white font-bold hover:bg-orange-400 transition-colors flex items-center gap-2'
                      >
                      ...
                      <button
                        onClick={onClose}
                        className='px-6 py-3 border border-zinc-700 text-zinc-300 hover:border-orange-500/50 hover:text-white transition-colors'
                      >
                        CLOSE
                      </button>
                    </div>
                  ...
                  >
                          ...
                          {currentStep.options?.map((option) => (
                            ...
                            >
                              <span className='font-mono text-xs text-orange-500 mr-3'>
                                {String(
                                  currentStep.options!.indexOf(option) + 1
                                ).padStart(2, '0')}
                              </span>
                              {option}
                            </button>
                    ...
                    {currentStep.type === 'text' && (
                      <p className='text-xs text-zinc-600 font-mono'>
                        Press <span className='text-orange-500'>Enter ↵</span>{' '}
                        to continue
                      </p>
                    )}
                  </motion.div>
