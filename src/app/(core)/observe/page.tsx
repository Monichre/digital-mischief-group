...
import type {Monitor} from '@/daedalus/scout/types'
...
export default function ObservePage() {
  ...
  return (
    <div className='min-h-screen bg-zinc-950 text-zinc-200 font-mono relative overflow-hidden'>
      ...
      <div
        className='absolute top-0 left-0 right-0 opacity-60 pointer-events-none'
        style={{
      ...
      <main className='max-w-6xl mx-auto px-6 py-12'>
        <div className='text-center mb-12'>
          ...
          <p className='text-zinc-500 max-w-xl mx-auto'>
            Deploy recon targets to monitor websites for changes. Get AI-powered
            summaries when content updates.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className='text-center py-12 border border-dashed border-zinc-800'>
            ...
            <p className='text-zinc-600 text-sm'>
              Deploy your first target to start tracking changes
            </p>
          </div>
        ) : (
