...
const DEPTH_OPTIONS: {
...
}[] = [
  {
    value: 'quick',
    label: 'Quick Scan',
    description: '~30 seconds, surface-level intel',
  },
  {
    value: 'standard',
    label: 'Standard',
    description: '~2 minutes, balanced depth',
  },
  {
    value: 'deep',
    label: 'Deep Dive',
    description: '~5 minutes, comprehensive analysis',
  },
]
        ...
        <div className='max-w-5xl mx-auto'>
          <ScrollReveal>
            ...
            <div className='text-center mb-12'>
              <Badge
                variant='outline'
                className='mb-4 border-orange-500/30 text-orange-500 font-mono'
              >
              ...
              <p className='text-zinc-400 max-w-2xl mx-auto mb-6'>
                ...
                sources. Get synthesized, actionable briefs in minutes.
              </p>
              <Link
                href='/research/live'
                ...
                {!showCreate ? (
                  ...
                  <div className='bg-zinc-900 border border-zinc-800 rounded-lg p-6 space-y-4'>
                    <div className='flex items-center justify-between mb-4'>
                      <h3 className='font-mono text-orange-500'>
                        // NEW MISSION
                      </h3>
                      <Button
                        variant='ghost'
      ...
      {isExpanded && (
        <div className='border-t border-zinc-800 p-4 space-y-4'>
          ...
          {mission.status === 'completed' && mission.summary && (
            <div className='space-y-4'>
              <div>
                <h5 className='font-mono text-xs text-zinc-500 mb-2'>
                  // INTELLIGENCE BRIEF
                </h5>
                <div className='bg-zinc-950 border border-zinc-800 rounded p-4'>
                  <ReactMarkdown
                    components={{
                      h1: ({children}) => (
                        <h1 className='text-xl font-mono text-orange-500 mb-4'>
                          {children}
                        </h1>
                      ),
                      h2: ({children}) => (
                        <h2 className='text-lg font-mono text-orange-500 mt-6 mb-3'>
                          {children}
                        </h2>
                      ),
                      h3: ({children}) => (
                        <h3 className='text-base font-mono text-orange-400 mt-4 mb-2'>
                          {children}
                        </h3>
                      ),
                      p: ({children}) => (
              ...
              {mission.findings && mission.findings.length > 0 && (
                <div>
                  <h5 className='font-mono text-xs text-zinc-500 mb-2'>
                    // RAW FINDINGS ({mission.findings.length})
                  </h5>
                  <div className='space-y-2 max-h-64 overflow-y-auto'>
                    {mission.findings.slice(0, 10).map((finding, i) => (
                      ...
                      >
                        ...
                        <h6 className='font-mono text-sm text-zinc-200 mb-1'>
                          {finding.title}
                        </h6>
