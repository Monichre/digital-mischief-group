...
export default function BrandReconPage() {
  ...
  const colorEntries = colors
    ? Object.entries(colors).filter(([, value]) => value)
    : []
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-12'>
            ...
            <h1 className='text-4xl md:text-5xl font-bold tracking-tight mb-4'>
              <span className='text-zinc-100'>Brand</span>{' '}
              <span className='text-orange-500'>Reconnaissance</span>
            </h1>
            <p className='text-zinc-400 max-w-xl mx-auto'>
              Extract complete brand identity from any URL or company email.
              Colors, typography, components—decoded in seconds.
            </p>
          </div>
