        ...
        {isVisible && (
          ...
          >
            <motion.div
              ...
              style={{
                boxShadow:
                  '0 0 10px 2px rgba(255,45,60,0.15), inset 0 0 0 1px rgb(240 66 66/0.1)',
              }}
            />
            <motion.div
              ...
              style={{
                boxShadow:
                  '0 0 3px 1px rgba(255,45,60,0.15), inset 0 0 0 1px rgb(240 66 66/0.3)',
              }}
            />
            <div
...
export const BotProtection = ({className}: BotProtectionProps) => {
  ...
  return (
    <div className={`relative h-[340px] w-full overflow-hidden ${className}`}>
      {/* Radar circles */}
      <svg
        className='absolute left-1/2 top-0 h-[680px] w-[680px] -translate-x-1/2'
        viewBox='0 0 680 680'
        fill='none'
      >
        <g
      ...
      >
        <div className='relative h-full w-full'>
          ...
          <motion.div
            ...
            style={{
              background:
                'conic-gradient(from -43deg, rgb(16 185 129) 42deg, transparent 42deg)',
              maskImage:
