        ...
        <div className="grid gap-8 lg:grid-cols-2 w-full">
          ...
          <Card className="flex flex-col bg-zinc-900/50 border-zinc-800">
            <CardHeader>
              ...
              <CardDescription className="font-mono">For individuals just getting started.</CardDescription>
            </CardHeader>
            ...
            <CardFooter>
              <Button disabled variant="outline" className="w-full font-mono border-zinc-700 text-zinc-500">
                CURRENT PLAN
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="flex flex-col border-orange-500/50 bg-zinc-900/80 shadow-lg shadow-orange-500/10 relative overflow-hidden">
            ...
            <CardHeader>
              ...
              <CardDescription className="font-mono">For power users who need more.</CardDescription>
            </CardHeader>
            <CardContent className="flex-1">
              <div className="text-4xl font-bold text-white">
                $29
