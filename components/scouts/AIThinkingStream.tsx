...
import type { SentinelStreamEvent, ConductorThought } from "@/lib/scouts/stream-types"
  ...
  return (
    <div className="border border-zinc-200 bg-white rounded-lg p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h4 className="text-sm font-semibold text-zinc-900">AI Analysis Stream</h4>
      </div>
            ...
            <div key={i} className="flex items-start gap-2 text-sm">
              ...
              <div className="flex-1 min-w-0">
                ...
                {thought.relatedPhase && (
                  <span className="text-xs text-zinc-500 ml-2">({thought.relatedPhase})</span>
                )}
