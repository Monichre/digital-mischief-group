...
import { Flame, Mail, Lock, User, ArrowRight, Loader2, Eye, EyeOff, Check } from "lucide-react";
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm border border-zinc-800 p-8 relative">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 font-mono">AGENT_REGISTRATION</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading || !passwordsMatch || !passwordRequirements.every((r) => r.met)}
