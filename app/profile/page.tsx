        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {success && (
            <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/30 rounded">
              ...
              <span className="text-green-400">Subscription activated successfully!</span>
            </div>
          )}
          {canceled && (
          ...
          <div className="border border-zinc-800 bg-zinc-900/30 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className={`px-3 py-1 rounded text-xs font-bold ${
                isPro ? "bg-orange-500/20 text-orange-400" : "bg-zinc-800 text-zinc-400"
              }`}>
            ...
            {isPro ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link href="/pricing" className="text-sm text-zinc-400 hover:text-orange-500 transition-colors">
            ...
            <div className="border border-zinc-800 bg-zinc-900/30 p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div className="text-2xl font-bold">{usage.enrichments.thisMonth}</div>
                  <div className="text-xs text-zinc-500">Enrichments</div>
                  <div className="text-[10px] text-zinc-600 mt-1">{usage.enrichments.total} total</div>
                </Link>
                ...
                >
                  ...
                  <div className="text-2xl font-bold">{usage.research.thisMonth}</div>
                  <div className="text-xs text-zinc-500">Research</div>
                  <div className="text-[10px] text-zinc-600 mt-1">{usage.research.total} total</div>
                </Link>
                ...
                >
                  ...
                  <div className="text-2xl font-bold">{usage.brands.thisMonth}</div>
                  <div className="text-xs text-zinc-500">Brand Analyses</div>
                  <div className="text-[10px] text-zinc-600 mt-1">{usage.brands.total} total</div>
                </Link>
              </div>
            </div>
          )}
