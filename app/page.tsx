...
export default function Home() {
  ...
  return (
    <div className='min-h-screen bg-zinc-950 text-zinc-200 selection:bg-orange-500 selection:text-white font-mono'>
            ...
            <div className='text-center max-w-4xl mx-auto'>
              ...
              <GlitchText>
                <h2 className='text-4xl md:text-6xl font-black mb-8'>
                  AI Everywhere.{' '}
                  <span className='text-orange-500'>Nowhere You Need It.</span>
                </h2>
              </GlitchText>
            ...
            >
              <Card className='border border-zinc-700 bg-zinc-900/95 backdrop-blur-sm p-8 hover:border-orange-500/50 transition-colors cursor-pointer'>
                ...
                <p className='text-zinc-400 mb-6 leading-relaxed'>
                  Unified, permissions-aware data intelligence layer. RAG
                  pipelines, vector stores, and semantic search—governed and
                  ready.
                </p>
              ...
              <Card className='border border-zinc-700 bg-zinc-900/95 backdrop-blur-sm p-8 hover:border-orange-500/50 transition-colors cursor-pointer'>
                ...
                <p className='text-zinc-400 mb-6 leading-relaxed'>
                  Role-specific copilots and command centers. Dashboards that
              ...
              <Card className='border border-zinc-700 bg-zinc-900/95 backdrop-blur-sm p-8 hover:border-orange-500/50 transition-colors cursor-pointer'>
                ...
                <p className='text-zinc-400 mb-6 leading-relaxed'>
                  Agents that act on signals, not just display them. Multi-agent
                  orchestration for autonomous, governed workflows.
                </p>
                <div className='flex items-center gap-2 text-xs text-orange-500/70 border-t border-zinc-800 pt-4'>
              ...
              <Card className='border border-zinc-700 bg-zinc-900/95 backdrop-blur-sm p-8 hover:border-orange-500/50 transition-colors cursor-pointer'>
                ...
                <p className='text-zinc-400 mb-6 leading-relaxed'>
                  Enablement and governance so it all sticks. Training,
                  documentation, and guardrails that scale with your team.
                </p>
                <div className='flex items-center gap-2 text-xs text-orange-500/70 border-t border-zinc-800 pt-4'>
            ...
            {[
              {
                num: '01',
                title: 'DIAGNOSTIC',
                desc: 'System Architecture Audit to map your current state',
              },
              {
                num: '02',
                title: 'ARCHITECTURE',
                desc: 'Cortex architecture, workflows, guardrails',
              },
              {
                num: '03',
                title: 'FABRICATION',
                desc: 'Implement Cortex, Interface, and Autopilot v1',
              },
              {
                num: '04',
                title: 'DEPLOYMENT',
                desc: 'Deploy to real users, monitor everything',
              },
              {
                num: '05',
                title: 'OVERWATCH',
                desc: 'Cortex Ops retainer for continuous improvements',
              },
            ].map((step, i) => (
      ...
      <section
        id='cases'
        className='py-32 border-t border-white/5 bg-zinc-900/30'
      >
          ...
          <ScrollReveal>
            <div className='max-w-4xl mx-auto text-center'>
              ...
              <p className='text-xl text-zinc-400 leading-relaxed mb-12'>
                We're not consultants. We're engineers who've built and scaled
                revenue systems at high-growth companies. We know what works
                because we've deployed it ourselves.
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className='max-w-6xl mx-auto'>
          <ScrollReveal>
            <div className='text-center mb-16'>
              ...
              <GlitchText>
                <h2 className='text-4xl md:text-6xl font-black mb-4'>
                  Daedalus <span className='text-orange-500'>Autonomous</span>{' '}
                  Reconnaissance
                </h2>
              </GlitchText>

              <p className='text-xl text-zinc-500 font-mono italic mb-8'>
                "No sleep, no surprises."
              </p>
              ...
              <p className='text-lg text-zinc-400 max-w-3xl mx-auto leading-relaxed'>
                ...
                geography, and narrative structures, then assembles the insights
                into <span className='text-orange-500'>actionable systems</span>
                .
              </p>
            </div>
          </ScrollReveal>
            ...
            <div className='text-center mb-16'>
              <div className='inline-flex items-center gap-3 px-6 py-3 border border-zinc-800 bg-zinc-900/50 rounded-full'>
                ...
                <span className='text-sm font-mono text-zinc-400'>
                  "It reads the internet's{' '}
                  <span className='text-orange-500'>thermal signature</span>."
                </span>
                <div className='w-2 h-2 bg-orange-500 rounded-full animate-pulse' />
              </div>
            </div>
            ...
            {[
              {
                ...
                desc: 'Deep identity analysis and visual fingerprinting',
              },
              {
                icon: Target,
                title: 'Competitor Recon Packs',
                desc: 'Full competitive intelligence dossiers',
              },
              {
                icon: Users,
                title: 'Persona Affinity Mapping',
                desc: 'Audience behavior and preference modeling',
              },
              {
                icon: Search,
                title: 'Autonomous Research Missions',
                desc: 'Self-directed deep-dive investigations',
              },
              {
                icon: Globe,
                title: 'Geo Intelligence & Scoring',
                desc: 'Location-based market opportunity analysis',
              },
              {
                icon: Activity,
                title: 'Narrative Change Detection',
                desc: 'Real-time market sentiment shifts',
              },
              {
                icon: Layers,
                title: 'Multi-Step Pipeline Orchestration',
                desc: 'Chained intelligence workflows',
              },
              {
                icon: Eye,
                title: 'Autonomous Watch Protocols',
                desc: '24/7 monitoring without human intervention',
              },
              {
                icon: AlertTriangle,
                title: 'Diff/Shift Monitoring',
                desc: 'Instant alerts on critical changes',
              },
            ].map((item, i) => (
              <ScaleReveal key={i}>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                ...
                <div className='p-5 border border-zinc-800 bg-zinc-950/50'>
                  ...
                  <p className='text-xs text-zinc-500 mb-4'>
                    Maps rising/declining narratives in real-time
                  </p>
                  <div className='space-y-1'>
                    {['Industries', 'Sectors', 'Fanbases', 'News Cycles'].map(
                      (item, i) => (
                        <div
                          key={i}
                ...
                <div className='p-5 border border-zinc-800 bg-zinc-950/50'>
                  ...
                  <p className='text-xs text-zinc-500 mb-4'>
                    Detects when competitor messaging becomes incoherent
                  </p>
                  <div className='text-xs text-orange-500 font-mono'>
                    → Gives DMG clients the ambush opportunity
                  </div>
                </div>
          ...
          <ScrollReveal delay={0.4}>
            <div className='text-center'>
              <p className='text-zinc-500 mb-6 font-mono text-sm'>
                Daedalus is the reconnaissance eye.{' '}
                <span className='text-orange-500'>Sentinels</span> are the boots
                on the ground.
              </p>
              <Magnetic>
                <button
