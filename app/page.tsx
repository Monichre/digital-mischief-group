...
import { FuseBackground } from "@/components/FuseBackground"
        ...
        <section className="py-32 border-t border-zinc-800/50">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-zinc-400 text-lg leading-relaxed mb-8">
              Your teams are trapped in <span className="text-zinc-200">POC Purgatory</span>. You have scripts that
              don't scale, agents you don't trust, and zero governance. You are burning budget on toys while competitors
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="group p-8 border border-zinc-800 hover:border-orange-500/50 transition-all duration-500 technical-border">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed mb-4">
                  From scattered POCs to a single Cortex powering sales & CS. 8× faster access to institutional
                  knowledge.
                </p>
        ...
        <footer className="py-8 border-t border-zinc-800/50">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-xs text-zinc-600">
              ...
              <span className="text-zinc-700">SYS.READY</span>
            </div>
          </div>
        </footer>
      </div>
